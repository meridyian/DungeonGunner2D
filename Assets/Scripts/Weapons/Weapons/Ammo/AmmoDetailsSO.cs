...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    [Tooltip(
        "Populate with the prefab to be used fpr the ammo. If multiple prefabs are specified then a random prefab from the array will be selected. The prefab can be an ammo pattern - as long as it conforms to the IFireable interface.")]
    ...
    [Tooltip(
        "If the ammo should 'charge' briefly before moving then set the time in seconds that the ammo is held charging after firing before relase")]
    #endregion
    ...
    #region Tooltip
    [Tooltip("the range of the ammo (or ammo pattern) int unity units")]
    #endregion
    ...
    [Tooltip(
        "This is the minimum number of ammo that are per shot. A random number of ammo are spawned between the min and max values.")]
    #endregion
    ...
    [Tooltip(
        "This is the maximum number of ammo that are per shot. A random number of ammo are spawned between the min and max values.")]
    #endregion
    ...
    private void OnValidate()
    {
        ...
        HelperUtilities.ValidateCheckPositiveRange(this, nameof(ammoSpreadMin),ammoSpeedMin, nameof(ammoSpreadMax), ammoSpreadMax, true);
